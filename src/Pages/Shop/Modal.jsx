                        ...
                        <div className="mt-2 grid grid-cols-4 gap-3">
                          {product.sizes.map((size) => (
                            <label
                              ...
                              className="has-checked:border-indigo-600 has-checked:bg-indigo-600 has-focus-visible:outline-2 has-focus-visible:outline-offset-2 has-focus-visible:outline-indigo-600 has-disabled:border-gray-400 has-disabled:bg-gray-200 has-disabled:opacity-25 group relative flex items-center justify-center rounded-md border border-gray-300 bg-white p-3"
                            >
                              <input
                              ...
                              />
                              <span className="group-has-checked:text-white text-sm font-medium uppercase text-gray-900">
                                {size.name}
                              </span>
                            </label>
                          ))}
