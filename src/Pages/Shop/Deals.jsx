...
export default function Deals() {
    ...
    const filtered = items.slice(19,25);
          ...
          {filtered.map((product) => (
            <div key={product.id} href={'/product'} className="group relative">
              ...
              <div className="my-1 flex gap-4 text-center text-gray-700">
                ...
                <div className='mt-8 flex items-center justify-between rounded-md bg-gray-600 p-1 text-2xl opacity-100 md:opacity-0 md:group-hover:opacity-100'>
